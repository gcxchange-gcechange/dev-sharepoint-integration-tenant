...
var ACEMySiteCacheManager = /** @class */ (function (_super) {
    ...
    function ACEMySiteCacheManager(_serviceScope) {
        var _this = _super.call(this) || this;
        _this._serviceScope = _serviceScope;
        _this._cacheEntries = {};
    ...
    ACEMySiteCacheManager.prototype._populateLocalCache = function (key, mySiteCacheData) {
        ...
        instanceIds.forEach(function (instanceId) {
            cacheEntry[instanceId] = mySiteCacheData[instanceId]; // tslint:disable-line: no-any
        });
        this._cacheEntries[key] = cacheEntry;
    };
